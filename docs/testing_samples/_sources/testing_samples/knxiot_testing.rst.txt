...
Both Light Switch Actuator and Sensor - depending on the boards used - are built with 1, 3, or 4 Functional Blocks with a single Switch On/Off Datapoint (type name: DPT_Switch, id: 1.001).
...
A board that is the recipient of the s-mode message checks its Group Object Table to confirm if the message can be processed.
...
* Light Switch Actuator Datapoints:
  ...
  | LED3   | /p/3  | Yes | Yes |                             |
  +--------+-------+-----+-----+-----------------------------+
  | LED4   | /p/4  | Yes | Yes | Not available for Thingy:53 |
  +--------+-------+-----+-----+-----------------------------+
...
* Light Switch Sensor Datapoints:
  ...
  | BUTTON1  | /p/1  | Yes | No  |                             |
  +----------+-------+-----+-----+-----------------------------+
  | BUTTON2  | /p/2  | Yes | No  | Not available for Thingy:53 |
  +----------+-------+-----+-----+-----------------------------+
  | BUTTON3  | /p/3  | Yes | No  | Not available for Thingy:53 |
  +----------+-------+-----+-----+-----------------------------+
  | BUTTON4  | /p/4  | Yes | No  | Not available for Thingy:53 |
  +----------+-------+-----+-----+-----------------------------+
