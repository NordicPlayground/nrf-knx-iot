...
void button0_pressed(const struct device *dev, struct gpio_callback *cb,
		    uint32_t pins)
{
  PRINT("Button 1 pressed, turning lights %s ", current_states[0] ? "on" : "off");
...
void button1_pressed(const struct device *dev, struct gpio_callback *cb,
		    uint32_t pins)
{
  PRINT("Button 2 pressed, turning lights %s ", current_states[0] ? "on" : "off");
...
void button2_pressed(const struct device *dev, struct gpio_callback *cb,
		    uint32_t pins)
{ 
  PRINT("Button 3 pressed, turning lights %s ", current_states[0] ? "on" : "off");
...
void button3_pressed(const struct device *dev, struct gpio_callback *cb,
		    uint32_t pins)
{
  PRINT("Button 4 pressed, turning lights %s ", current_states[0] ? "on" : "off");
